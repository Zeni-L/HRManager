		...
		if(funcionario != null) {
			...
			switch (opcao) {
				case 1:
					...
					break;
				case 2:
					System.out.println("Folha ponto não esta completa!");
					break;
				case 3:
					...
					System.out.println("\nNome: " + ponto.getFuncionario().getNome() +
							"\nMatricula: " + ponto.getFuncionario().getMatricula() + 
							"\nData da folha ponto: " + ponto.getDiaDoPonto().format(dataFormatter) +
							"\nHora entrada: " + ponto.getEntrada().format(horaFormatter) +
							"\nHora Saida: " + ponto.getSaida().format(horaFormatter) +
							"\nJornada de trabalhado: " + retorno[0] + ":" + retorno[1] + ":" + retorno[2]);
					break;
				default:
